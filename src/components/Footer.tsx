...
export default function Footer() {
  return (
    <footer className="relative z-10 bg-white pb-12 pt-16 lg:pb-16 lg:pt-20 dark:bg-dark">
          ...
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-7 text-base text-body-color dark:text-dark-6">
                VibeNear is your ultimate platform for connecting businesses and students, 
                creating opportunities that drive innovation and growth.
              </p>
