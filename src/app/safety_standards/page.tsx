...
export default function SafetyStandards() {
  ...
  useEffect(() => {
    const loadHtmlContent = async () => {
      try {
        const response = await fetch('/files/Safety_Standards_csae.html')
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="bg-[#102C66] text-white px-8 py-6">
              <h2 style={{ color: '#ffffff' }} className="text-3xl text-white font-bold">VibeNear - Safety Standards Against CSAE</h2>
            </div>

            {/* HTML Content */}
            <div className="p-8">
              <div
                className="safety-standards-content prose prose-lg max-w-none"
