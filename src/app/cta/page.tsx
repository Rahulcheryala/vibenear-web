...
export default function CTAPage() {
  return (
    <>
      ...
      <section className="bg-white py-12 lg:py-16 dark:bg-dark">
            ...
            <div className="flex flex-wrap items-center">
              <div className="w-full px-4 lg:w-1/2">
                <span className="mb-4 block text-base font-medium text-white">
                  Find Your Next Dream Opportunity
                </span>
              ...
              <div className="w-full px-4 lg:w-1/2">
                <div className="flex flex-wrap lg:justify-end">
                  <a 
                    href="#"
                    className="hover:bg-shadow-1 my-1 mr-4 inline-flex rounded-md bg-white px-7 py-3 text-base font-medium text-primary transition hover:bg-gray-100"
                  >
                    Get Pro Version
                  </a>
                  <a 
                    href="#"
                    className="my-1 inline-flex rounded-md bg-blue-600 px-7 py-3 text-base font-medium text-white transition hover:bg-blue-700"
                  >
                    Start Free Trial
                  </a>
                </div>
